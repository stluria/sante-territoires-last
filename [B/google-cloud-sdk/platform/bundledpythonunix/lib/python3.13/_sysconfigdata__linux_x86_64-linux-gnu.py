...
build_time_vars = {
    ...
    "COREPYTHONPATH": "",
    "COVERAGE_INFO": "/build/Python-3.13.11/coverage.info",
    "COVERAGE_LCOV_OPTIONS": "--rc lcov_branch_coverage=1",
    "COVERAGE_REPORT": "/build/Python-3.13.11/lcov-report",
    ...
    "PYTHONPATH": "",
    "PYTHON_FOR_BUILD": "_PYTHON_PROJECT_BASE=/build/Python-3.13.11 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_x86_64-linux-gnu _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /build/Python-3.13.11/`cat pybuilddir.txt`) /tools/host/bin/python3.13",
    ...
    "RESSRCDIR": "",
    "RETSIGTYPE": "void",
    "RUNSHARED": "LD_LIBRARY_PATH=/build/Python-3.13.11",
    ...
    "TESTOPTS": "",
    "TESTPATH": "",
    "TESTPYTHON": "LD_LIBRARY_PATH=/build/Python-3.13.11 _PYTHON_PROJECT_BASE=/build/Python-3.13.11 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_x86_64-linux-gnu _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /build/Python-3.13.11/`cat pybuilddir.txt`) /tools/host/bin/python3.13",
    "TESTPYTHONOPTS": "",
    "TESTRUNNER": "LD_LIBRARY_PATH=/build/Python-3.13.11 _PYTHON_PROJECT_BASE=/build/Python-3.13.11 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_x86_64-linux-gnu _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /build/Python-3.13.11/`cat pybuilddir.txt`) /tools/host/bin/python3.13 -m test",
    ...
    "abs_builddir": "/build/Python-3.13.11",
    "abs_srcdir": "/build/Python-3.13.11",
